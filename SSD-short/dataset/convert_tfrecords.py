...
def main(unused_argv):
    FLAGS.dataset_directory='/home/yhq/Desktop/SSD-short/VOCROOT/'
    FLAGS.output_directory='/home/yhq/Desktop/SSD-short/dataset/tfrecords'
    assert not FLAGS.train_shards % FLAGS.num_threads, ('Please make the FLAGS.num_threads commensurate with FLAGS.train_shards')
    assert not FLAGS.validation_shards % FLAGS.num_threads, ('Please make the FLAGS.num_threads commensurate with '
